    ...
    ConverterForm.convert = function (inID, outID, errID) {
      ...
      // We want TextToIPA to exist, or we can't lookup words
        ...
        if (typeof outID === 'string') {
          ...
          alert("hi");
          ConvertIPAToMusic(IPAText);//this is the function that will do all that
          //after we send the IPA Text to be outputted we are going to parse it for specific characters and get sylablles and emphasis
        } else {
